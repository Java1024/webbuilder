package org.webbuilder.office.excel.support.template.reader;
...
public class TemplateExcelReader<T> extends CommonExcelReader<T> {
    ...
    protected void parseConfig() throws Exception {
        ...
        for (List<Expression> expressions : templateInfo) {
    ...
    public static void main(String[] args) throws Exception {
        TemplateExcelReader reader = new TemplateExcelReader();
        reader.setTemplate(FileUtils.getResourceAsStream("template.xlsx"));
        reader.parseConfig();
    }
}
